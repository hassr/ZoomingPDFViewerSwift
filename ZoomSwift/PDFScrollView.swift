...
class PDFScrollView: UIScrollView, UIScrollViewDelegate {
    ...
    */
    ...
    func scrollViewWillBeginZooming(scrollView: UIScrollView, withView view: UIView!) {
        println(pretty_function_string() + " scrollview.zoomScale = \(self.zoomScale)")
    ...
    */
    func scrollViewDidEndZooming(scrollView: UIScrollView, withView view: UIView!, atScale scale: CGFloat) {
        println(pretty_function_string() + "BEFORE " + " PDFScale = \(PDFScale)")

        // Set the new scale factor for the TiledPDFView.
        PDFScale *= scale
        println(pretty_function_string() + "AFTER " + " PDFScale = \(PDFScale)" + "newFrame = \(self.oldTiledPDFView.frame)")
